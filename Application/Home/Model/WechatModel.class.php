...
class WechatModel extends Model{
        static $req_keys = array( "Content", "CreateTime", "FromUserName", "Label",
                                "Location_X", "Location_Y", "MsgType", "PicUrl",
                                "Scale", "ToUserName", "MusicUrl","HQMusicUrl",
                                "Event","EventKey");
        public $token;
    	...
    	public function get_creat_time(){
        ...
        public function reply($callback){
            ...
            else if(array_key_exists("murl",$arg)){
        ...
        function http_curl($url, $type='get', $res='json', $arr=''){
            ...
            $ch = curl_init();
            //2.设置curl参数
            curl_setopt($ch, CURLOPT_URL, $url);    //抓取页面
        ...
        function xiaojo($key, $from, $to){
            ...
            $postArr = array(
         	...
         	$url    = "http://www.xiaojo.com/api5.php";   //聊天机器人
            $postJson = json_encode($postArr);
            $replys = http_curl($url, $postJson);
